...
tech_edu<-ggpredict(lm4, terms=c("Positive_tech [1,3,5,7,10]", "Social_media_usage [1,7]"))
...
ggplot(tech_edu, aes(x = factor(x, levels = 1:10), 
  ...
  scale_fill_manual(name = "Social Media Usage",
                    ...
                    labels = c("1" = "Daily", "7" = "Never")) +  # Update legend labels
...
tech_edu<-ggpredict(lm4, terms=c("Inter_trust [1:4, by=1]", "Social_media_usage [1,7]"))
